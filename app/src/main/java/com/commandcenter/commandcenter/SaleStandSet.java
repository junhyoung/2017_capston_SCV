...
public class SaleStandSet {
    ...
    public SaleStandSet(Context context) {
        ...
        saleStands[3].saleStandLocation[1] -= (electronicsLoad.getHeight()/2);
        ...
        saleStands[7].saleStandLocation[1] -= (booksLoad.getHeight()/2);
        ...
        saleStands[11].saleStandLocation[1] -= (officeLoad.getHeight()/2);
        ...
        saleStands[15].saleStandLocation[1] -= (blankTopLoad.getHeight()/2);
        ...
        saleStands[19].saleStandLocation[1] -= (cdLoad.getHeight()/2);
